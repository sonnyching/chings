...
public interface IMessageDao {
    ...
    public int subscribe(long user,long target,int targetType,String reason);
    ...
    public List<Subscription> querySubScribe(long userId);
    public List<Subscription> queryMessagesBy(long userId,long target,long targetType,String action);
